...
def main():
    ...
    extract_energy_molecules_from_folder(host_folder, monomer_folder, args.number_of_host, args.number_of_monomers, args.number_of_complexes, args.results_folder)
