...
def bond_radii():
    bondRadii = {symbol: [r, r-0.1, r-0.2]
...
def check_coords2(mol0, mol1):
    ...
    vdw_1 = bondRadii[mol0[i1].symbol][0]
    vdw_2 = bondRadii[mol1[i2].symbol][0]
            ...
            if system_def[this_frag].frag_type == "L" or system_def[this_frag].frag_type == "P":
                ...
                while not keep_coords:
                    ...
                    if keep_coords:
                        ...
                        this_origin = random.choice(dummy_mol).position
                        attempts = 0
        complex = 'complex_' + str(ci)
        new_mol_energy = compute_sp.compute_xtb_energy(new_mol)
        energy_dict[complex] = new_mol_energy
        complex_molecules[complex] = new_mol

        free_energy = energy_dict[complex]['energy_kcal_mol'] - (
